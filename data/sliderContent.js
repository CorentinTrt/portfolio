...
const sliderContent = [
    ...
    tools: [
      {
        label: 'react',
        logo: () => (
          <ReactJs width={'3rem'} height={'3rem'} color={'#0A0A0A'} />
        ),
      },
      {
        label: 'gatsby',
        logo: () => <Gatsby width={'3rem'} height={'3rem'} color={'#0A0A0A'} />,
      },
      {
        label: 'graphql',
        logo: () => (
          <Graphql width={'3rem'} height={'3rem'} color={'#0A0A0A'} />
        ),
      },
      {
        label: 'mysql',
        logo: () => <Mysql width={'3rem'} height={'3rem'} color={'#0A0A0A'} />,
      },
    ],
    ...
    tools: [
      {
        label: 'typescript',
        logo: () => (
          <Typescript width={'3rem'} height={'3rem'} color={'#0A0A0A'} />
        ),
      },
      {
        label: 'node.js',
        logo: () => (
          <Nodedotjs width={'3rem'} height={'3rem'} color={'#0A0A0A'} />
        ),
      },
      {
        label: 'mongoDb',
        logo: () => (
          <Mongodb width={'3rem'} height={'3rem'} color={'#0A0A0A'} />
        ),
      },
    ],
  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        label: 'three.js',
        logo: () => (
          <Threedotjs width={'3rem'} height={'3rem'} color={'#0A0A0A'} />
        ),
      },
      {
        label: 'craft',
        logo: () => (
          <Craftcms width={'3rem'} height={'3rem'} color={'#0A0A0A'} />
        ),
      },
    ],
  ...
  },
  {
    ...
    tools: [
      ...
      {
        label: 'ios',
        logo: () => <Ios width={'3rem'} height={'3rem'} color={'#0A0A0A'} />,
      },
      {
        label: 'android',
        logo: () => (
          <Android width={'3rem'} height={'3rem'} color={'#0A0A0A'} />
        ),
      },
      {
        label: 'node.js',
